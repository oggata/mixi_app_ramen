	...
	function checkaccount(){
		...
		var url = "http://mixiapp.blamestitch.com/car/check_account/name:" + EncStr + "/id:" + viewer.memberid + "/category:1/";
		var params = {};
		//HTTPメソッドの指定
	...
	function savedatascore(score){
		...
		//ニックネームはURLエンコードをかけないと渡らない
		var EncStr = encodeURI( viewer.nickname );
		var url = "http://mixiapp.blamestitch.com/car/insert_score/id:" + viewer.memberid + "/score:" + score + "/category:1/";
	...
	function getResultHtml(){
		var EncStr = encodeURI( viewer.nickname );
		var url = "http://mixiapp.blamestitch.com/cake/car/return_score/id:" + viewer.memberid + "/category:1/";
		var params = {};
		//HTTPメソッドの指定
		params[gadgets.io.RequestParameters.METHOD] = gadgets.io.MethodType.POST;
		//外部サーバから得られるコンテンツの期待する形式
